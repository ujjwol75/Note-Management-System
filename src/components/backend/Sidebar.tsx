  ...
  return (
    <div className="w-[220px] h-[752px] bg-[#FFFFFF] text-[#37474F] p-8 font-Inter font-medium grid content-between">
      <div>
        ...
        <Link href="Dashboard">
          <div
            className={`my-1 w-[172px] h-[40px] rounded-[10px] text-white bg-theme flex items-center  p-2 cursor-pointer space-x-3 `}
        ...
        <Link href="Authors">
          <div
            className={` my-1  w-[172px] h-[40px] rounded-[10px]   flex items-center  p-2 cursor-pointer space-x-3 `}
          >
            <AiFillFolderAdd />
            <span>Authors</span>
          </div>
        ...
        <Link href="Readers">
          <div className="my-1  w-[172px] h-[40px] rounded-[10px]  flex items-center  p-2 cursor-pointer space-x-3">
            <RiBookReadFill />
            <span>Readers</span>
          </div>
        </Link>
        ...
        <Link href="Settings">
          <div className=" my-3 w-[172px] h-[40px] rounded-[10px]  flex items-center  p-2 cursor-pointer">
            <svg
