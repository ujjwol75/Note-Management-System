...
const authors = [
  {
    ...
    membershipDate: "2020",
    description:
      "Lorem Ipsum is simply at dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled.",
  },
  {
      ...
      <div className="grid grid-cols-3 p-7 text-[15px]">
        ...
        <div className="font-Inter font-normal text-[#323232] space-y-2 col-span-2 mt-5">
          <p className="mr-6 font-medium ">
            Name
            <span className="ml-20 pl-2 font-normal">:{authors[0].name}</span>
          </p>
          <p className="mr-6 font-medium">
            Member since
            <span className="ml-5 pl-2 font-normal">
              :{authors[0].membershipDate}
            </span>
          </p>
          <p className="mr-6 font-medium">
            Description
