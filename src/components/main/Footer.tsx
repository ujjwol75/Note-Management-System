    ...
    return (
        < footer >
            <div className=' relative h-full w-full'>
                ...
                <div className='relative top-0 left-0 p-14 grid grid-cols-1  md:grid-cols-5 space-y-10 '>
                    <div className='text-white  xl:text-[1.1rem] md:col-span-2 xs:mr-7 sm:mr-10 md:mr-16  xl:mr-20 '>
                        ...
                        <p className='text-sm md:text-base font-Inter text-[#E5E5E5] '>The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using &aposContent here, content here&apos, making it look like readable English. Many desktop publishing.</p>
                    </div>
                    <div className='col-span-3'>
                        <div className='grid grid-col-1 text-sm lg:text-base xs:grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 space-y-10 xs:space-y-0 '>
                            ...
                            <div className='flex flex-col  text-white md:-ml-6'>
                                <div>
                            ...
                            <div className='flex flex-col  text-white'>
                                ...
                                <div className='flex flex-col space-y-1 font-medium font-Inter sm:text-sm  md:text-md lg:text-base leading-[26px]'>
                                    <p>Support</p>
                                    <p>About Us</p>
                                    <p>Contact Us</p>
                                    <p>Trending Notes</p>
            ...
            <div className='text-xs sm:text-base  lg:text-lg flex items-center justify-center bg-black text-white h-12'>
                <p className='mb-2 text-[15px]'>Copyright © 2022 NoteGhar - All rights reserved. </p>
