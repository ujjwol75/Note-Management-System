...
export default function Coverpage({ height }: Props) {
    return (
        <div className='relative h-[400px]  sm:h-[500px] md:h-[550px] lg:h-[650px] xl:h-[755px] w-full' >
            ...
            <div className='absolute w-full h-full top-0 space-y-3  left-0  lg:space-y-6 lg:-mt-14 flex flex-col items-center justify-center'>
                <div className='text-[6vw] xs:text-[5vw] sm:text-[4.2vw] font-bold text-white font-Jost not-italic text-center'>
                ...
                <div className='flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-y-0 '>
                    <div className='mr-4 cursor-pointer'>
                        <button className='theme-btn hidden md:block'> Become Publisher</button>
