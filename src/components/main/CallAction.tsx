...
export default function CallAction() {
    return (
        <div className='relative w-full h-[450px] sm:h-[550px] md:h-[600px]  '  >
            ...
            <div className='absolute top-0 left-0 flex flex-col items-center justify-center w-full h-full space-y-3 md:space-y-3 lg:space-y-4 xl:space-y-10 '>
                ...
                <div className=' text-center text-white mx-28 '>
                    <p className='text-xs xs:text-base px-6 md:px-20 lg:px-96 font-Inter text-[#FFFFFF] '>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                </div>
