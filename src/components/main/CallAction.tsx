...
export default function CallAction() {
    return (
        <div className='relative w-full h-[300px] sm:h-[400px] md:h-[560px]  '  >
            ...
            <div className='absolute top-0 left-0 flex flex-col items-center justify-center w-full h-full space-y-3 md:space-y-6 lg:space-y-8  '>
                ...
                <div className=' text-center text-white sm:mx-20  '>
                    <p className='text-xs md:text-sm px-12 sm:px-6 md:px-20 lg:px-40 xl:px-96 font-Inter text-[#FFFFFF] leading-[23px] font-medium '>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                </div>
