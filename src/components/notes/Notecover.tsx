    ...
    return (
        <div className='relative w-full h-[270px]'>
            ...
            <div className='absolute w-full h-full left-0 top-0 text-center flex flex-col items-center justify-center'>
                <h2 className='font-Jost font-bold text-white text-heading2 tracking-wider'>Notes</h2>
                <h2 className='font-Jost font-medium text-white text-sm xs:text-lg lg:text-xl leading-[29px] '>Home - <span className='text-button'>{detail}</span></h2>
            </div>
