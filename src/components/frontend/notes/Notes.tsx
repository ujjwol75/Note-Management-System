    ...
    <div className="m-6 sm:m-10 text-[#37474F]">
      ...
      <div className="md:w-full text-sm leading-[17px] md:leading-[24px] text-justify font-Inter font-medium text-[#37474F] ">
        <p className="mb-5">
          ...
          repeat that predefined chunks as necessary, making this the first true
          dummy generator on the Internet.
        </p>
        <p className="mb-5">
          It uses a dictionary of over 200 Latin words, combined Lorem the Ipsum
          looks reasonable. Grursus mal suada faci lisis Lorem ipsum dolarorit
          more ametion consectetur elit. Vesti at bulum nec odio aea the dumm
          ipsumm ipsum that dolocons rsus mal suada and fadolorit to the and
          consectetur elit. All the Lorem Ipsum generators on the Internet tend
          to repeat that predefined chunks as of necessary, making dummy
