        ...
        <div className='m-6 sm:m-10 '>
            ...
            <div className=' w-full h-full xl:w-[780px] xl:h-[392px] p-5 sm:p-10 md:p-12 rounded-md border-[#E0E0E0] border-2'>
                <div className='flex items-center justify-center sm:justify-between'>
                    <div className='flex flex-col xs:flex-row  items-center justify-center text-center xs:text-left '>
                        <div className='relative h-12 w-12 xs:h-16 xs:w-16 sm:h-24 sm:w-24 md:h-28 md:w-28 '>
                            ...
                            <Image src='/exam.png' alt='reviewer' className='rounded-[50%]' layout='fill' />
                        </div>
                        <div className=' xs:ml-8'>
                            <h3 className='text-md mb-1 sm:mb-2 xs:text-[25px] leading-[28px] font-semibold font-Jost'>Sarah Jain</h3>
                            <p className='text-theme text-sm font-normal font-Inter leading-[17px]'>Socialogy, Physics and Biology</p>
                        </div>
                    </div>
                ...
                <div className='mt-5 xs:text-sm sm:text-sm font-Inter  text-themetext font-medium  '>
                    <p className=' text-sm text-justify leading-[22px] font-medium'>Grursus mal suada faci lisis Lorem ipsum dolarorit more ametion consectetur elit. Vesti at bulum nec odio
