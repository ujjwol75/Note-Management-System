        ...
        <div className='w-full h-full lg:h-[632px] pt-[42px] lg:pt-[20px] xl:pt-[82px] '>
            < div className='   h-full lg:h-[550px] mx-[22px] sm:mx-[55px] md:mx-[65px] lg:mx-[80px]  xl:mx-[125px] flex flex-col items-center justify-center lg:flex-row   ' >
                ...
                <div className='  text-[#37474F] grid grid-cols-1 content-center  xl:pb-24' >
                    <div>
                        <h1 className='text-2xl sm:text-3xl lg:text-heading  font-bold font-Jost pr-20 '>Manage Your Notes Access & Read Anywhere</h1>
                    </div>
                    <div className='mt-[28px]' >
                        <p className=" font-medium text-sm sm:text-base    font-Inter leading-normal pr-10 ">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                    ...
                    <div className='flex mt-6 '>
                        ...
                        <div className='flex flex-col space-y-2'>
                            ...
                            <p className="text-sm sm:text-base font-medium  sm:mt-3 md:mr-32 lg:mr-0 font-Inter leading-normal pr-20 ">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                        </div>
                    </div>
                    <div className='flex mt-6'>
                        <div className='mx-4'>
                        ...
                        <div className='flex flex-col space-y-2'>
                            ...
                            <p className="text-sm sm:text-base font-medium  sm:mt-3  md:mr-32 lg:mr-0  font-Inter leading-normal pr-20 ">It is a long established fact that a reader will be distracted by the readable
